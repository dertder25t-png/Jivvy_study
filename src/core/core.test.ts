...
describe('notes routing', () => {
  ...
  it('detects coverage gaps', () => {
    const gaps = coverageGaps({
      ...
      topics,
      notes: [{ id: 'n', user_id: 'u', course_id: course.id, topic_id: topics[0].id, parent_note_id: null, title: null, body: 'x'.repeat(80), captured_via: 'in_app', course_inferred: false, outline: null, test_date: null, created_at: '', updated_at: '' }],
    });
